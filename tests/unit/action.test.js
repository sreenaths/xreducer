...
describe('Unit Test : action() creation', () => {

  test('With custom type name and payload', () => {
    let customType;
  ...
  test('With debounce wait and payload', (done) => {
    let reducer = createReducer({
  ...
  test('Calling action from inside handler', () => {
    let actions;
    let reducer = createReducer({
      simpleHandler: (s, p) => p,
