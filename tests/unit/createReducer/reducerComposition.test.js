...
describe('Unit Test : Reducer Composition', () => {

  test('By combining two xReducers', () => {
    let handlers = {
  ...
  test('By combining two xReducers and calling actions from one another', () => {
  ...
  test('By combining an xReducers and a normal reducer', () => {
  ...
  test('By combining nested xReducers', () => {
    let handlers = {
      inc: (state, payload) => state + payload,
    };
